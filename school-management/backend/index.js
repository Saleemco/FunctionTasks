...
app.get('/api/grades/filter', async (req, res) => {
  try {
    const { studentId, subjectId, type, teacherId, termId, category } = req.query;
    const where = {};
...
// Calculate final grade for a student (CA 40% + Exam 60%)
